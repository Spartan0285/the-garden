...
$SSH "$host" "
    ...
    for k in GDDebugSnapshotPath GDDebugPage GDDebugInstallFile GDDebugMinSeconds GDDebugQuit GDDebugScroll GDDebugDock GDDebugViewOnSite GDDebugHostArch GDDebugHostOS GDDebugUpdate; do
